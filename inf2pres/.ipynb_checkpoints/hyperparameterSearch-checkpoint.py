...
# u rjecniku hiperparametri su hiperparametri poslagani: batch_size, filter_sizes, num_filters, dropout_rate
#hiperparametri = {'hp1':[25, [1, 2, 3, 5], 36, 0.1], 'hp2':[50, [1, 2, 3, 5], 36, 0.1], 'hp3':[25, [1, 2, 3, 5], 5, 0.1], 'hp4':[50, [1, 2, 3, 5], 5, 0.1],\
#                 'hp5':[25, [1, 2, 3], 5, 0.1], 'hp6':[50, [1, 2, 3], 5, 0.1], 'hp7':[25, [1, 2, 3, 5], 10, 0.1], 'hp8':[50, [1, 2, 3, 5], 10, 0.1], \
#                 'hp9':[25, [1, 2, 3], 10, 0.1],'hp10':[50, [1, 2, 3], 10, 0.1]}
hiperparametri = {'hp9':[25, [1, 2, 3], 10, 0.1],'hp10':[50, [1, 2, 3], 10, 0.1]}
...
for hp in hiperparametri:
    ...
    print('batch_size: %d, filter_sizes: %s, num_filters: %d'%(hiperparametri[hp][0], str(hiperparametri[hp][1]), hiperparametri[hp][2]))
    file.write('batch_size: %d, filter_sizes: %s, num_filters: %d \n'%(hiperparametri[hp][0], str(hiperparametri[hp][1]), hiperparametri[hp][2]))
    ...
    tl, vl, vacc, vrmse = cross_validate(model, train_set_cv, output_path, batch_size = hiperparametri[hp][0], lr=0.005)
